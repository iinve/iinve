import { ashi_lamiya } from "DB/Ashi-Lamiya";
...
const Page = () => {
  return (
    <div>
      ...
      <CoffeePremium data={ashi_lamiya} />
    </div>
  );
};
